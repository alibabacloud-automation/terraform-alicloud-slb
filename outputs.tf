locals {
  this_slb_name                     = var.use_existing_slb ? (concat(data.alicloud_slbs.this.balancers[*].load_balancer_name, [""])[0]) : (var.create ? concat(alicloud_slb.this[*].load_balancer_name, [""])[0] : "")
  this_slb_network_type             = var.use_existing_slb ? (concat(data.alicloud_slbs.this.balancers[*].network_type, [""])[0]) : ""
  this_slb_status                   = var.use_existing_slb ? (concat(data.alicloud_slbs.this.balancers[*].status, [""])[0]) : (var.create ? concat(alicloud_slb.this[*].status, [""])[0] : "")
  this_slb_vpc_id                   = var.use_existing_slb ? (concat(data.alicloud_slbs.this.balancers[*].vpc_id, [""])[0]) : ""
  this_slb_vswitch_id               = var.use_existing_slb ? (concat(data.alicloud_slbs.this.balancers[*].vswitch_id, [""])[0]) : (var.create ? concat(alicloud_slb.this[*].vswitch_id, [""])[0] : "")
  this_slb_address                  = var.use_existing_slb ? (concat(data.alicloud_slbs.this.balancers[*].address, [""])[0]) : (var.create ? concat(alicloud_slb.this[*].address, [""])[0] : "")
  this_slb_tags                     = var.use_existing_slb ? (concat(data.alicloud_slbs.this.balancers[*].tags, [{}])[0]) : (var.create ? concat(alicloud_slb.this[*].tags, [{}])[0] : {})
  this_slb_slave_availability_zone  = var.use_existing_slb ? (concat(data.alicloud_slbs.this.balancers[*].slave_zone_id, [""])[0]) : (var.create ? concat(alicloud_slb.this[*].slave_zone_id, [""])[0] : "")
  this_slb_master_availability_zone = var.use_existing_slb ? (concat(data.alicloud_slbs.this.balancers[*].master_zone_id, [""])[0]) : (var.create ? concat(alicloud_slb.this[*].master_zone_id, [""])[0] : "")
}
...
output "this_slb_acl_entry_attachment" {
  ...
  description = "The entry attachment of the acl"
}
